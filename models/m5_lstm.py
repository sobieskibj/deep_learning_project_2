...
class M5LSTMModel(nn.Module):
    def __init__(self, n_outputs, channels_base=32):
        ...
        self.lstm = nn.LSTM(2 * channels_base, 2 * channels_base, batch_first=True)
...
class M5LSTMSystem(pl.LightningModule):
    def __init__(
        self,
        model,
        train_loss_weights,
