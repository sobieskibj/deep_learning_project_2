...
class MelSpecLSTMModel(nn.Module):
    def __init__(self, n_outputs, channels_base=16, dropout_p=0.5):
        ...
        self.lstm = nn.LSTM(8 * channels_base, 4 * channels_base, batch_first=True)
        self.classifier = nn.Sequential(
            nn.Linear(4 * channels_base, 4 * channels_base),
...
class MelSpecLSTMSystem(pl.LightningModule):
    def __init__(
        self,
        model,
        train_loss_weights,
